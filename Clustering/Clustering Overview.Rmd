...
dist(height_weight)
```
Now scale the height and weight pairs to be centered at 0 with standard devation 1 and calculate distance
```{r}
...
Heirarchical, K-means, PAM, Prinicial Component Analysis (PCA)