...
Generally $e$ is chosen for the base $b$, though other bases are possible.  The regression coefficients are often found with a maxium likelihood estimation that requires an iterative process.
